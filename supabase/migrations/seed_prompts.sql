-- Seed AI Prompts with default values from Edge Functions
-- Run this ONCE after creating the ai_prompts table
...
-- Note: write-draft and analyze-seo prompts are too long for this file
-- Add them separately using Supabase SQL Editor or via API
