-- Add remaining prompts: write-draft and analyze-seo
-- Run this in Supabase SQL Editor if you already executed 004_seed_prompts.sql
...
INSERT INTO ai_prompts (function_name, display_name, description, system_prompt, default_prompt) VALUES (
  ...
  $$당신은 비즈니스/산업 분석 블로그 작가입니다. 주어진 개요를 바탕으로 고품질 블로그 글을 작성합니다.
